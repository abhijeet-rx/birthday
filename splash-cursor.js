function initSplashCursor(userConfig = {}) {
  const canvas = document.getElementById('fluid-canvas') || (function() {
  ...
  const config = {
    ...
    PAUSED: false,
    BACK_COLOR: userConfig.BACK_COLOR ?? { r: 0.5, g: 0, b: 0 },
    TRANSPARENT: userConfig.TRANSPARENT ?? true,
    RAINBOW_MODE: userConfig.RAINBOW_MODE ?? true,
    COLOR: userConfig.COLOR ?? '#FFB7C5'
  };
